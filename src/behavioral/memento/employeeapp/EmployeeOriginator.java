...
public class EmployeeOriginator {
    ...
    public EmployeeOriginator(int empId, String empName, String empPhoneNo,String empDesignation)
    {
        this.empId=empId;
    ...
    public EmployeeMemento saveToMemento() {
        ...
        EmployeeMemento empMemento = new EmployeeMemento(this.empId, this.empName, this.empPhoneNo, this.empDesignation );
        return empMemento;
    }
